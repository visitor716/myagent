...
def main():
    ...
    sources = {
        'apps/cc-connect/start-cc-connect-hidden.py': root/'apps'/'cc-connect'/'start-cc-connect-hidden.py',
        'apps/cc-connect/restart-cc-connect-hidden.py': root/'apps'/'cc-connect'/'restart-cc-connect-hidden.py',
        'apps/file-transfer/fileCopyUpMain.py': root/'apps'/'file-transfer'/'fileCopyUpMain.py',
        'apps/task-scheduler/CheckTask.py': root/'apps'/'task-scheduler'/'CheckTask.py',
        'apps/task-scheduler/CreateTaskWithSchtasks.py': root/'apps'/'task-scheduler'/'CreateTaskWithSchtasks.py',
    }
