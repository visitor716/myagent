...
def main():
    ...
    cmd=[sys.executable, str(Path(__file__).resolve().parents[1] / 'start-cc-connect-hidden' / 'start-cc-connect-hidden.py'), '--config-path', args.config_path, '--log-path', args.log_path]
