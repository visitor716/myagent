...
#
# 使用方法：
#   bash scripts/sync-chatgpt-project-docs/sync-chatgpt-project-docs.sh --project-url <url> [--dry-run] [--keep-tab]
#
# 参数：
...
# 合并文档
{
    ...
    echo "> 此文件由 scripts/sync-chatgpt-project-docs/sync-chatgpt-project-docs.sh 自动生成"
    echo ""
    echo "---"
    echo ""
