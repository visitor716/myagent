...
```bash
bash /home/zhanxp/projects/myagent/skills/skills-local/my-tg-gateway-manager/scripts/collect_worktree_evidence.sh --project <project-path> --worker <worker-name>
```

只有临时文件 probe 可接受时才加：

```bash
bash /home/zhanxp/projects/myagent/skills/skills-local/my-tg-gateway-manager/scripts/collect_worktree_evidence.sh --project <project-path> --worker <worker-name> --probe
```
