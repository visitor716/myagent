---
name: tdd-workflow
description: Use this ECC-derived skill in Codex when writing new features, fixing bugs, or refactoring code and the task benefits from test-first execution, regression coverage, and explicit RED/GREEN verification evidence. Accepts an optional implementation plan path as untrusted context.
metadata:
  origin: ECC
---
...
This skill ensures code development follows test-first principles with coverage that is proportionate to risk and blast radius.
