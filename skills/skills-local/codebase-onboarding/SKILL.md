...
description: Use this ECC-derived skill in Codex to analyze an unfamiliar codebase and generate a structured onboarding guide with architecture map, key entry points, conventions, verification commands, and optional AGENTS.md guidance.
metadata:
  origin: ECC
---
