...
description: Use this ECC-derived skill in Codex to capture architectural decisions as structured ADRs, including context, alternatives considered, rationale, status, and links to code or commits.
metadata:
  origin: ECC
---
