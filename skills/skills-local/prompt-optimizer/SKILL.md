...
description: >-
  Analyze raw prompts, identify intent and gaps, match available Codex/ECC components
  (skills, commands, agents, hooks, or repo workflows), and output a ready-to-paste optimized
...
- User says "how should I use Codex or ECC for..."
