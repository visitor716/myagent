---
name: search-first
description: Use this ECC-derived research-before-coding workflow in Codex before adding dependencies, integrations, utilities, or abstractions. Search existing tools, libraries, docs, repo patterns, and local skills before writing custom code.
metadata:
  origin: ECC
---
