...
- The daemon runs as a background Node.js process managed by platform supervisor (launchd on macOS, `systemd --user` or setsid fallback on Linux, WinSW/NSSM on Windows).
